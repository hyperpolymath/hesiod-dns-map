...
// Replace hesiod-dns-map, Hesiod Dns Map — See README.adoc for details., just run, Hesiod Dns Map started successfully. with actuals
= hesiod-dns-map — Quick Start for Users
:toc:
:toclevels: 2

== What is hesiod-dns-map?

Hesiod Dns Map — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./hesiod-dns-map-portable
----
...
[source]
----
Hesiod Dns Map started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/hesiod-dns-map/wiki
