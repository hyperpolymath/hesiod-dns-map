{
  description = "hesiod-dns-map - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 hesiod-dns-map development environment"
            echo "Language: rust"
            echo ""
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P hesiod-dns-map.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/hesiod-dns-map $out/bin/  # Rust
            # cp bin/hesiod-dns-map $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/hesiod-dns-map";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-hesiod-dns-map" {
